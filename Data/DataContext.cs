...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<PersonagemHabilidade> TB_PERSONAGEMHABILIDADES { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Armas() { Id = 1, Nome = "Exbalibur", Dano = 90, PersonagemId = 1 },
                new Armas() { Id = 2, Nome = "Cetro", Dano = 80, PersonagemId = 2 },
                new Armas() { Id = 3, Nome = "Cacetete", Dano = 25, PersonagemId = 3 },
                new Armas() { Id = 4, Nome = "Espada", Dano = 50, PersonagemId = 4 },
                new Armas() { Id = 5, Nome = "Foice", Dano = 65, PersonagemId = 5 },
                new Armas() { Id = 6, Nome = "Arco", Dano = 40, PersonagemId = 6 },
                new Armas() { Id = 7, Nome = "Chinelo de Mãe", Dano = 100, PersonagemId = 7 }
             ...
             (
                ...
                new Habilidade(){Id=1, Nome="Hipnotizar", Dano=37}
             );
